...
namespace Subscriptions.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class GetSubscriptionsData :  IEquatable<GetSubscriptionsData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSubscriptionsData" /> class.
        /// </summary>
        ...
        public GetSubscriptionsData(Guid? id = default(Guid?), string description = default(string), string webhookUrl = default(string), string hmacKey = default(string), List<string> events = default(List<string>))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetSubscriptionsData {\n");
        ...
        {
            return this.Equals(input as GetSubscriptionsData);
        }

        /// <summary>
        /// Returns true if GetSubscriptionsData instances are equal
        /// </summary>
        /// <param name="input">Instance of GetSubscriptionsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetSubscriptionsData input)
        {
            if (input == null)
                return false;
